...
export const navigationItems: NavigationItem[] = [
  ...
  { id: 'writeups', label: 'Writeups', module: 'writeups/', command: 'ls /writeups/', icon: 'shield', order: 6, visible: true, visibility: 'public' },
  { id: 'process', label: 'Process', module: 'process.pipeline', command: 'run /pipelines/process.pipeline', icon: 'git-branch', order: 7, visible: true, visibility: 'public' },
  { id: 'experience', label: 'Experience', module: 'career.log', command: 'tail -f /logs/career.log', icon: 'briefcase', order: 8, visible: true, visibility: 'public' },
  { id: 'contact', label: 'Contact', module: 'connect.sh', command: './connect.sh', icon: 'send', order: 9, visible: true, visibility: 'public' },
];

export const quickCommands: QuickCommand[] = [
  { command: 'help', output: 'modules: identity, origin, capabilities, toolchain, builds, writeups, process, career, connect' },
  ...
  { command: 'open writeups', target: 'writeups', output: 'Opening public lab writeup index...' },
