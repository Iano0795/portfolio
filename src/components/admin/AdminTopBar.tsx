...
export function AdminTopBar({ adminEmail, environment }: AdminTopBarProps) {
  return (
    <header className="relative z-10 flex h-12 flex-shrink-0 items-center justify-between border-b border-[#00ff88]/20 bg-[#090d16]/95 px-4 shadow-[0_0_24px_rgba(0,255,136,0.08)]">
      <div className="flex min-w-0 items-center gap-3">
        ...
        <div className="min-w-0 font-mono">
          <div className="truncate text-sm leading-none text-[#00ff88]">IanOS Control Center</div>
          <div className="mt-1 hidden truncate text-[10px] text-gray-500 sm:block">{adminEmail}</div>
        </div>
      </div>
