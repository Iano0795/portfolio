...
type AccessRequestDetailPanelProps = {
  ...
  onClose: () => void;
  onApprove: (data: any) => Promise<FlatApproveResult>;
  onReject: (data: any) => Promise<FlatRejectResult>;
  onRevoke: (data: any) => Promise<FlatRevokeResult>;
};
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 font-mono text-xs text-gray-400">
                  Slug:{" "}
                  <span className="text-cyan-300">{request.writeup_slug}</span>
                </p>
                ...
                <div>
                  ...
                  <p className="mt-1 font-mono text-xs text-green-300">
                    {request.grant.expires_at
                      ? formatDate(request.grant.expires_at)
                      : "Never"}
                  </p>
                </div>
                <div>
                  ...
                  <p className="mt-1 font-mono text-xs text-green-300">
                    {request.grant.views_used} /{" "}
                    {request.grant.max_views ?? "∞"}
                  </p>
                </div>
              </div>
          ...
          {activeForm === "none" && canMutate && (
            <AccessRequestActions
              ...
              onRevoke={async () => {
                if (
                  request.grant &&
                  confirm("Are you sure you want to revoke this grant?")
                ) {
