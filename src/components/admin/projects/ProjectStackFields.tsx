...
type ProjectStackFieldsProps = {
  disabled: boolean;
  stack: EditableListItem[];
  onChange: (stack: EditableListItem[]) => void;
};

export function ProjectStackFields({ disabled, stack, onChange }: ProjectStackFieldsProps) {
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-3">
        <h2 className="font-mono text-xs text-cyan-400">Stack</h2>
        <button
          type="button"
          disabled={disabled}
